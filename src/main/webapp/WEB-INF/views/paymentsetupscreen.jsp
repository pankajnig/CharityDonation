...
<link href="https://fonts.googleapis.com/css2?family=Source+Serif+4:wght@300&display=swap" rel="stylesheet">
  ...
  <div class="form-group">
    ...
    <input style="width: 60%;" onkeypress='validateNumber(event)' type="text" class="form-control" id="formGroupExampleInput4" placeholder="Amount" oninput="copyInputValue()">
  </div>
  <div class="form-group">
    <h3><label for="formGroupExampleInput5">Want to Donate some money</label></h3>
    <div style=" border:2px solid #ccc; width:300px; height: 150px; overflow-y: scroll;"></div>
    <label>Select Any</label>
<div id="hello" class="form-group">
    <input name="fooby[1][]" type="checkbox" /> ${charity1}<br />
    <input name="fooby[1][]" type="checkbox" /> ${charity2} <br />
    <input name="fooby[1][]" type="checkbox" /> ${charity3} <br />
    <input name="fooby[1][]" type="checkbox" /> ${charity4} <br />
    <input name="fooby[1][]" type="checkbox" /> ${charity5}<br />
</div>
  </div>
<div class="form-group">
